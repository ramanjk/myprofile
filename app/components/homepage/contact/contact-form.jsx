...
function ContactForm() {
  ...
  const handleSendMail = (e) => {
    ...
    // Create mailto link
    const subject = `Message from ${userInput.name} - Portfolio Contact`;
    const body = `Hello Kuruva Ramanjaneyulu,

My name is ${userInput.name} and I'm reaching out through your portfolio website.
